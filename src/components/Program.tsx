...
export default function Program() {
  return (
    <section id="program" className="py-16 md:py-24 bg-riksa-cream relative">
      <div className="container mx-auto px-4 sm:px-6">
        <FadeIn className="text-center mb-10 md:mb-16">
          <h2 className="font-serif text-3xl sm:text-4xl text-riksa-brown-dark font-bold mb-4">Agenda Utama</h2>
          <div className="w-16 h-1 bg-riksa-orange mx-auto rounded"></div>
        </FadeIn>

        <FadeIn delay={0.2} className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl overflow-hidden border border-riksa-gold/30 relative">
            ...
            <div className="p-5 sm:p-8 md:p-12">
              <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-stretch md:items-start">
                ...
                {/* Date Highlight */}
                <div className="flex-shrink-0 bg-riksa-cream rounded-2xl p-5 sm:p-6 text-center border border-riksa-gold/20 md:min-w-[140px]">
                ...
                <div className="flex-grow">
                  <h3 className="font-serif text-2xl sm:text-3xl font-bold text-riksa-brown-dark mb-4">
