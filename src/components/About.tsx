...
export default function About() {
  return (
    <section id="about" className="py-16 md:py-24 bg-riksa-cream relative">
      <div className="container mx-auto px-4 sm:px-6 max-w-4xl text-center">
        <FadeIn>
          <h2 className="font-serif text-3xl sm:text-4xl text-riksa-brown-dark font-bold mb-4">Tentang RIKSA</h2>
          <div className="w-16 h-1 bg-riksa-orange mx-auto mb-8 rounded"></div>
        </FadeIn>
        
        <FadeIn delay={0.2}>
          <p className="text-base sm:text-lg md:text-xl text-riksa-brown-dark/80 leading-relaxed font-sans mb-6 sm:mb-8">
          ...
          <p className="text-base sm:text-lg md:text-xl text-riksa-brown-dark/80 leading-relaxed font-sans">
